...
def registration(request):
    if request.method == 'POST':
        ...
        if password1 == password2:
            ...
            # sending email
            send_mail('Restaurant - Profile Activation', message_text, 'mngarg89@gmail.com', [new_user.username],
                      fail_silently=False)
    ...
    if request.method == 'POST':
        ...
        if len(selected_friends) == 0:
            ...
            for this_friend in selected_friends:
                ...
                send_mail('Restaurant - Invitation', text_to_send, 'mngarg89@gmail.com', [friend_guest.user.username],
                          fail_silently=False)
